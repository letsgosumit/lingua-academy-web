  ...
  <main className="pt-20">
    ...
    <section className="section-blue section-padding text-center">
      <div className="section-container">
        ...
        <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }} className="mt-8 text-white/70 max-w-2xl mx-auto leading-relaxed">
    ...
    <section className="section-padding bg-background">
      <div className="section-container max-w-3xl">
        <h2 className="font-display text-2xl md:text-3xl font-bold text-primary heading-underline mb-8">Our Story</h2>
        <p className="text-muted-foreground leading-relaxed mb-5 mt-6">
    ...
    <section className="section-light section-padding">
      <div className="section-container text-center">
        <h2 className="font-display text-2xl md:text-3xl font-bold text-primary heading-underline">What We Stand For</h2>
